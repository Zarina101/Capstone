...
```{r}
df_MCPS<-df_MCPS%>% rename('high_school'='school_name' , 'HS_city' ='city', 'HS_zip' = 'zip_code')
...
save dataframes Degrees
```{r}
write_csv(df_Degrees,'df_Degrees.csv')
```

```{r}

write_csv(df_MCPS,'df_MCPS.csv')
